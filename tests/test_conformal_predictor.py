...
class TestConformalPredictor(unittest.TestCase):
    ...
    @patch("onlineconformal.onlineconformal.ThetaModel")
    ...
    @patch("onlineconformal.onlineconformal.fit_ar_quantile_loss", return_value=np.array([2, 3]))
    ...
    def test_fit(self):
        ...
        with patch("onlineconformal.utils.quantile_loss", side_effect=dummy_quantile_loss):
    ...
    def test_eval(self):
        ...
        with patch("onlineconformal.onlineconformal.eval", side_effect=dummy_eval) as mock_eval:
